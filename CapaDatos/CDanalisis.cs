...
namespace CapaDatos
{
    public class CDanalisis

    {
        private int dIdAnalisis;
        private string dNombre, dDescripcion;
        public CDanalisis()
        { }

        public CDanalisis(int pIdAnalisis,  string pNombre, string pDescripcion)
        {
        ...
        public string Insertar(CDanalisis objAnalisis)
        {
            string mensaje = "";
            ...
            try
            {
                ...
                SqlCommand micomando = new SqlCommand("Insertar_Analisis", sqlCon);
                ...
                */
                ...
                micomando.Parameters.AddWithValue("@pnombre", objAnalisis.Nombre);
                micomando.Parameters.AddWithValue("@pdescripcion", objAnalisis.Descripcion);
...
*/
        ...
        public string Actualizar(CDanalisis objAnalisis)
        {
            string mensaje = "";
            SqlConnection sqlCon = new SqlConnection();
            try
            {
                ...
                sqlCon.Open();
                micomando.CommandType = CommandType.StoredProcedure;
                micomando.Parameters.AddWithValue("@pidanalisis", objAnalisis.IdAnalisis);
                micomando.Parameters.AddWithValue("@pnombre", objAnalisis.Nombre);
                micomando.Parameters.AddWithValue("@pdescripcion", objAnalisis.Descripcion);
        ...
        public DataTable AnalisisConsultar(String miparametro)
        {
            ...
            try
            {
                ...
                sqlCmd.CommandText = "AnalisisConsultar"; //Nombre del Proc. Almacenado a usar
