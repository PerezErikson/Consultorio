...
namespace CapaDatos
{
    public class CDusuario
    {
        ...
        public CDusuario(int pIdUsuario, string pNombre, string pApellido,string pNUsuario, string pContrasena )
        {
            dIdUsuario = pIdUsuario;
            dNombre = pNombre;
            dApellido = pApellido;
            dNUsuario = pNUsuario;
            dContrasena = pContrasena;
        ...
        {
            get { return dNUsuario; }
            set { dNUsuario = value; }
        }
        public string Contrasena
        {
            get { return dContrasena; }
            set { dContrasena = value; }
        }
        ...
        public string Insertar(CDusuario objUsuario)
        {
            ...
            try
            {
                ...
                SqlCommand micomando = new SqlCommand("Insertar_Usuario", sqlCon);
                ...
                */
                ...
                micomando.Parameters.AddWithValue("@pnusuario", objUsuario.NUsuario);
                micomando.Parameters.AddWithValue("@pcontrasena", objUsuario.Contrasena);
...
*/
        ...
        public DataTable ConsultaUsuario(String miparametro)
        {
            ...
            try
            {
                ...
                sqlCmd.CommandText = "ConsultaUsuario"; //Nombre del Proc. Almacenado a usar
