...
namespace CapaDatos
{
   public class CDestudio
    {
        private int dIdEstudio;
        private string dNombre;
        public CDestudio()
        { }

        public CDestudio(int pIdEstudio, string pNombre)
        {
            dIdEstudio = pIdEstudio;
            dNombre = pNombre;
        ...
        {
            get { return dIdEstudio; }
            set { dIdEstudio = value; }
        }
        ...
        public string Insertar(CDestudio objEstudio)
        {
            string mensaje = "";
            ...
            try
            {
                ...
                SqlCommand micomando = new SqlCommand("Insertar_Estudio", sqlCon);
                ...
                */
                ...
                micomando.Parameters.AddWithValue("@pNombre", objEstudio.Nombre);
...
*/
        ...
        public string Actualizar(CDestudio objEstudio)
        {
            string mensaje = "";
            SqlConnection sqlCon = new SqlConnection();
            try
            {
                sqlCon.ConnectionString = Conexionconsultorio.miconexion;
                SqlCommand micomando = new SqlCommand("EstudioActualizar", sqlCon);
                sqlCon.Open();
                micomando.CommandType = CommandType.StoredProcedure;
                micomando.Parameters.AddWithValue("@pidestudio", objEstudio.IdEstudio);
                micomando.Parameters.AddWithValue("@pnombre", objEstudio.Nombre);
        ...
        public DataTable EstudioConsultar(String miparametro)
        {
            ...
            try
            {
                ...
                sqlCmd.CommandText = "EstudioConsultar"; //Nombre del Proc. Almacenado a usar
