...
{
    public partial class FConsultaPaciente : Form
    {
        ...
        public FConsultaPaciente()
        {
            InitializeComponent();
        }

        private void FConsultaPaciente_Load(object sender, EventArgs e)
        {
        ...
        private void fillByToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.pacienteTableAdapter.FillBy(this.database1DataSet.Paciente);
            }
        ...
        {
            FPacienteParametro fPacienteparametro = new FPacienteParametro();
            fPacienteparametro.parametro = tbBuscar.Text;
            fPacienteparametro.ShowDialog();
